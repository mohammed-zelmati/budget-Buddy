# Créer un outil de gestion financière à l’aide d’une interface graphique et une
# base de données, permettant le suivi de vos comptes. Cet outil permet
# l’affichage de toutes les transactions ainsi que leur ajout (dépenses et revenu).

# Une transaction est représentée par au moins : une référence, une
# description, un montant, une date et un type (retrait, dépôts, transfert).

# La gestion financière est un outil contenant des informations sensibles et
# personnelles. Il ne devrait pas être accessible sans sécurité. Ajouter un
# module de connexion.
...
# au minimum dix caractères. Un hachage serait bienvenu.
